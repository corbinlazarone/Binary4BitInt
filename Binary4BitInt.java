...
{ int b3, b2, b1, b0;
  ...
  { return (-8 * this.b3 + 4 * this.b2 + 2 * this.b1 + this.b0);
  }
  ...
  { Binary4BitInt first, second, sum;
    ...
    int b3, b2, b1, b0;
    for (int i = 0; i < 5; i++)
    {   System.out.print("\nEnter 1st 4-bit binary integer (with a space " + 
                         "between the bits): ");
        b3 = scan.nextInt();
        b2 = scan.nextInt();
        b1 = scan.nextInt();
        ...
        System.out.print("\nEnter 2nd 4-bit binary integer (with a space " + 
                         "between the bits): ");
        b3 = scan.nextInt();
        b2 = scan.nextInt();
        b1 = scan.nextInt();
        ...
        System.out.println("Binary sum: " + sum.toString() +
                           " = " + sum.binaryToDecimal());
        scan.close();
    }
  }
